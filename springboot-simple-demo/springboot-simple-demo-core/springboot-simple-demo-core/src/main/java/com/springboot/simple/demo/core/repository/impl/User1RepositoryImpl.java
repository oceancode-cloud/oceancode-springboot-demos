...
import com.springboot.simple.demo.core.mapper.slave1.User1Mapper;
...
/**
 * <B>User1RepositoryImpl</B>
 *
 * <p>
 * This is a class that implement User1Repository
 * </p>
 *
 * @author Dynamic Gen
 * @see User1Repository
...
@Primary
@Component
public class User1RepositoryImpl implements User1Repository {
    @Resource
    private CommonConfig commonConfig;

    @Resource
    private User1Mapper targetMapper;

    @Resource(name = "slave1NamedParameterJdbcTemplate")
    private NamedParameterJdbcTemplate jdbcTemplate;

    @Resource(name = "slave1PlatformTransactionManager")
    private PlatformTransactionManager transactionManager;

    @Resource(name = "slave1SqlSessionFactory")
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(User1RepositoryImpl.class);

    public User1RepositoryImpl(ApplicationContext applicationContext) {
    ...
    static {
        FIELD_WITH_OBJECT_TYPE_MAPPING = new HashMap<>(5);
    }
     ...
     */
    @Override
    public User1 findById(Long id, boolean throwEx) {
     ...
     */
    @Override
    public List<User1> findByIds(Set<Long> ids, boolean throwEx) {
        ...
        List<User1> list = targetMapper.selectByIds(ids);
    ...
    @Override
    public List<User1> findByIds(Set<Long> ids) {
        return findByIds(ids, true);
    }

    @Override
    public List<User1> findByIds(Long id, Long... ids) {
     ...
     */
    @Override
    public boolean addOne(User1 entity) {
        return addOne(entity, true);
    }

    @Override
    public boolean addOne(User1 entity, boolean throwEx) {
     ...
     */
    @Override
    public boolean updateById(User1 entity, boolean throwEx) {
    ...
    @Override
    public boolean updateById(User1 entity) {
        return updateById(entity, true);
    }

    @Override
    public boolean updateBatchById(List<User1> list) {
        return updateBatchById(list, 100);
    }

    @Override
    public boolean updateBatchById(List<User1> list, int batchSize) {
        ...
        return SqlUtil.batchUpdateOrInsert(sqlSessionFactory, list, User1Mapper.class, (item, mapper) -> {
    ...
    public void populateAddFieldDomain(User1 entity) {
        populateUpdateFieldDomain(entity);
    }

    public void populateUpdateFieldDomain(User1 entity) {
    }
